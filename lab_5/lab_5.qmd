...
В результате лабораторной работы были импортированы, подготовлены и проанализированы данные трафика Wi-Fi сетей из готового датасета.

## Вывод

Закрепили навыки по анализу трафика беспроводных сетей и работы с пакетами `dplyr` и `lubridate`