...
Установка пакетов `dplyr`, `jsonlite`, `tidyr`, `xml2` и `rvest`.
...
В результате выполнения лабораторной работы были импортированы и проанализированы данные журнала Windows Active Directory.

## Вывод

Закрепили навыки использования языка программирования R для обработки данных и получили навыки исследования данных журнала Windows Active Directory.